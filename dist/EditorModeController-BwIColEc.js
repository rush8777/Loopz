import { E as ExperienceRenderer, i as isGuideDefinition } from "./ExperienceRenderer-CQBsSD4y.js";
import { S as SelectorGenerator } from "./module-Be25Lonf.js";
class EditorBridge {
...
class EditorModeController {
  ...
  mount(draft, bridge, requestedStep = 0) {
    ...
    const activeGroups = new Set(guide || widgetType === "anchored_card" ? ["anchored", "target"] : widgetType === "hotspot" ? ["anchored", "hotspot", "target"] : widgetType === "modal" ? ["modal", "overlay"] : widgetType === "slideout" ? ["slideout", "overlay"] : widgetType === "toast" ? ["toast"] : ["cursor"]);
    ...
    const syncStep = () => {
      ...
      (_c = root.querySelector("[data-step-label]")) == null ? void 0 : _c.replaceChildren(`Editing step ${stepIndex + 1} of ${(guide == null ? void 0 : guide.steps.length) ?? 1}`);
...
//# sourceMappingURL=EditorModeController-BwIColEc.js.map
