...
export class ExperienceRenderer {
  ...
  private root(experienceId: string): ShadowRoot {
    this.host = document.createElement("div"); this.host.dataset.loopzExperience = experienceId; this.host.dataset.loopzExperienceRoot = experienceId; this.host.style.cssText = "position:fixed;inset:0;z-index:2147483000;pointer-events:none";
