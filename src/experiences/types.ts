...
export interface EditorDraft { experience: { id: string; name: string; kind: ExperienceKind; widgetType: WidgetType | null }; version: { id: string; versionNumber: number; definition: RuntimeDefinition & { targeting: unknown } } }
